    ...
    <section className="hero">
      <div className="container">
        <div className="hero-grid">
          ...
          {/* ── Colonne gauche ── */}
          <div>
            <div className="hero-eyebrow fade-up" style={{ animationDelay: '0s' }}>
            ...
            <p className="hero-sub fade-up" style={{ animationDelay: '0.2s' }}>
              <strong>10 ans à gérer des systèmes audio critiques en live</strong> — stades,
              arenas, tournées internationales. Aujourd'hui, la même rigueur appliquée au code.
              Fullstack JS avec une spécialisation DevOps en amont.
            </p>
            ...
            <div className="hero-meta fade-up" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="card-list">
                {cardRows.map(({ label, value, accent }) => (
                  <div key={label} className="card-row">
                    ...
                    <span className={`card-row-value${accent ? ' accent-text' : ''}`}>
                      {value}
                    </span>
                  </div>
                ))}
