...
export const projets: Project[] = [
  ...
  },
  {
    ...
    tech: ['React/Vite', 'Tailwind v4', 'shadcn/ui', 'TanStack Query', 'MongoDB Atlas'],
    links: [
      { label: 'GitHub →', href: 'https://github.com/Maxime-Maguet/respawn-backend', variant: 'primary' },
      { label: 'Démo live', href: 'https://respawn-frontend-roan.vercel.app/home', variant: 'ghost' },
    ],
  ...
  },
  {
    ...
    tech: ['Next.js 15', 'TypeScript', 'Tailwind v4', 'shadcn/ui', 'Framer Motion', 'Resend'],
    links: [
      { label: 'GitHub →', href: 'https://github.com/Maxime-Maguet', variant: 'primary' },
    ],
  },
]
